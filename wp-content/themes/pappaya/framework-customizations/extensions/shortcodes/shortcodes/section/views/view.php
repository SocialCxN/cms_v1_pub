...
$section_style   = ( $bg_color || $text_color || $bg_image ) ? 'style="' . esc_attr($bg_color . $text_color . $bg_image) . '"' : '';
$container_class = ( isset( $atts['is_fullwidth'] ) && $atts['is_fullwidth'] ) ? 'fw-container-fluid' : 'fw-container';
?>
<div class="section fw-main-row <?php echo esc_attr($section_extra_classes) ?> <?php echo !empty($atts['no_padding']) ? 'no-padding' : ''; ?>" <?php echo ( $section_style ); ?> <?php echo ( $bg_video_data_attr ); ?>>
