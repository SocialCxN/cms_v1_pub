...
$style_class = $atts['table']['header_options']['table_style_class'];
?>
<div class="fw-pricing<?php  if(isset($style_class)&&strlen($style_class)>0){echo ' '.esc_attr($style_class);} ?>">
	<?php foreach ($atts['table']['cols'] as $col_key => $col): ?>
		<div class="fw-package-wrap <?php echo esc_attr($class_width . ' ' . $col['name']); ?> ">
			<div class="fw-package card">
